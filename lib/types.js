...
function registerType(type, validator) {
  if (type instanceof Function) {
    ...
    if (!(validator instanceof Function)) {
      throw new (exceptions.TypeException)('Validator must be a function for `' + type + '`');
    }
  }

  if (typeof type !== 'string') {
    throw new (exceptions.TypeException)('Type name must be a string `' + String(type) + '`');
  } else if (!type.replace(/\s/g, '').length) {
    throw new (exceptions.TypeException)('Type name must not be empty');
  } else if (!TYPE_NAME_REGEX.test(type)) {
    throw new (exceptions.TypeException)('Invalid type name `' + type + '`');
  }
...
function isRegistered(type) {
  ...
  return registry[type] || primitives[type];
}
...
function _integer(v) {
  ...
  if (typeof v !== 'number') {
    throw new (exceptions.ValidationException)('Invalid integer `' + v + '`');
  }
...
function _number(v) {
  ...
  if (typeof v !== 'number') {
    throw new (exceptions.ValidationException)('Invalid number `' + v + '`');
  }
...
function _string(v) {
  ...
  if (typeof v === 'number') {
    ...
    throw new (exceptions.ValidationException)('Invalid string `' + v + '`');
  }
...
function _boolean(v) {
  ...
  if (typeof v === 'number') {
    ...
    throw new (exceptions.ValidationException)('Invalid boolean `' + v + '`');
  }
...
function _array(v) {
  ...
  if (!(v instanceof Array)) {
    throw new (exceptions.ValidationException)('Invalid array `' + v + '`');
  }
...
function _object(v) {
  ...
  if (Object.prototype.toString.call(v) !== '[object Object]') {
    throw new (exceptions.ValidationException)('Invalid object `' + (typeof v) + '`');
  }
...
function _customValidator(CustomType) {
  return function customValidator(v) {
    ...
    throw new (exceptions.ValidationException)('Invalid type `' + (typeof v) + '`');
  };
}
