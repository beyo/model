          ...
          if (Model && json[jsonKey] !== null) {
            if (typeDef.indexes) {
              if (Array.isArray(json[jsonKey])) {
                ...
                this[key] = json[jsonKey] === null || json[jsonKey] === undefined ? json[jsonKey] : ([ isModel(json[jsonKey]) ? json[jsonKey] : Model(json[jsonKey]) ]);
              }
            } else {
              this[key] = json[jsonKey] === null || json[jsonKey] === undefined || isModel(json[jsonKey]) ? json[jsonKey] : Model(json[jsonKey]);
            }
          } else {
